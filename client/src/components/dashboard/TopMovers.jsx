        ...
        <div className="space-y-1">
          {gainers.map((stock, i) => (
            <motion.button
              ...
              className="w-full flex items-center justify-between p-2.5 rounded-xl hover:bg-green-500/10 transition-colors group text-left"
            >
              <div>
        ...
        <div className="space-y-1">
          {losers.map((stock, i) => (
            <motion.button
              ...
              transition={{ delay: 0.05 * i }}
              onClick={() => handleClick(stock.symbol)}
              className="w-full flex items-center justify-between p-2.5 rounded-xl hover:bg-red-500/10 transition-colors group text-left"
            >
              <div>
