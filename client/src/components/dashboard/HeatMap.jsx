...
export default function HeatMap({ stocks = [] }) {
  ...
  return (
    ...
    >
      <h3 className="font-display font-semibold text-sm mb-3">Market Heat Map</h3>
        ...
        {stocks.slice(0, 50).map((stock, i) => {
          ...
          return (
            <motion.button
              ...
              className="relative p-2 rounded-lg text-center transition-transform hover:scale-105 hover:z-10 hover:shadow-lg"
      ...
      <div className="flex items-center justify-center gap-2 mt-4 text-[10px] text-kite-muted">
        <div className="flex items-center gap-1">
          <div className="w-3 h-3 rounded-sm bg-red-600" />
          <span>Bearish</span>
        </div>
        <div className="w-16 h-2 rounded-full bg-gradient-to-r from-red-600 via-gray-600 to-green-600" />
        <div className="flex items-center gap-1">
